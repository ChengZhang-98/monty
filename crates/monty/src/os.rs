...
pub fn stat_result(
    ...
    MontyObject::NamedTuple {
        ...
        values: vec![
            MontyObject::Int(st_mode).into(),
            MontyObject::Int(st_ino).into(),
            MontyObject::Int(st_dev).into(),
            MontyObject::Int(st_nlink).into(),
            MontyObject::Int(st_uid).into(),
            MontyObject::Int(st_gid).into(),
            MontyObject::Int(st_size).into(),
            MontyObject::Float(st_atime).into(),
            MontyObject::Float(st_mtime).into(),
            MontyObject::Float(st_ctime).into(),
        ],
    }
}
