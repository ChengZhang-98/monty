...
impl PyMontyRepl {
    ...
    #[pyo3(signature = (code, *, inputs=None, external_functions=None, print_callback=None, structured_print_callback=None, mount=None, os=None, skip_type_check=false))]
    fn feed_run<'py>(
        &self,
        py: Python<'py>,
        code: &Bound<'_, PyString>,
    ...
    #[expect(clippy::too_many_arguments)]
    #[pyo3(signature = (code, *, inputs=None, print_callback=None, structured_print_callback=None, mount=None, os=None, skip_type_check=false))]
    fn feed_start<'py>(
        slf: &Bound<'py, Self>,
        py: Python<'py>,
        code: &Bound<'_, PyString>,
    ...
    #[expect(clippy::too_many_arguments)]
    #[pyo3(signature = (code, *, inputs=None, external_functions=None, print_callback=None, structured_print_callback=None, os=None, skip_type_check=false))]
...
/// Converts a Python dict of `{name: value}` pairs into the `Vec<(String, AnnotatedObject)>`
